    ...
    <div class="login">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="before-btn flex">
          <div class="flex">
            <Input v-model="checkboxValue" class="checkbox" type="checkbox" placeholder="Email" /><Text
              class="save-text" text="Đồng ý với điều khoản sử dụng của của XBEST" />
          </div>
        </div>
        ...
        <div class="after-btn flex">
          ...
          <router-link :to="{ name: 'login' }">
            <Link class="register" text="Đăng nhập">
            </Link>
          </router-link>
        </div>
      </form>
